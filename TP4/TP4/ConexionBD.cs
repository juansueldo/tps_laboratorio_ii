...
namespace Entidades
{
    public static class ConexionBD
    {
        ...
        public static ListaProgramadores Leer()
        {
            ListaProgramadores listaProgramadores = new ListaProgramadores();
            ...
            try
            {
                ...
                while (myReader.Read())
                {
                    programador = new Programador(myReader["nombre"].ToString(), myReader["apellido"].ToString(), (Genero)myReader["genero"],
                        (Puesto)myReader["puesto"], (short)myReader["idLegajo"], (short)myReader["edad"]);
